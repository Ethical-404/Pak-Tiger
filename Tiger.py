#!/usr/bin/python2
# coding=utf-8
# code by Ethical-404 (Arbab Memon)
# my facebook ( https://www.facebook.com/ArbabMemon )
...
def man():
        ...
        pw = raw_input("  [*] enter the Your Choice password  : ").split(",")
        if len(pw) ==0:
